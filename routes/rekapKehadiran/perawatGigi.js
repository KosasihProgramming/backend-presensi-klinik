...
router.post("/cek", async function (req, res, next) {
  ...
  const stringQuery = `SELECT * FROM rekap_hadir_perawat_gigi WHERE bulan = ? AND tahun = ?`;
...
router.post("/delete", async function (req, res, next) {
  ...
  const stringQuery = `DELETE FROM rekap_hadir_perawat_gigi WHERE bulan = ? AND tahun = ?`;
